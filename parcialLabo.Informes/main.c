...
int main()
{
    ...
    do
    {
        ...
        case 'I':
            ...
            break;
        case 'J':
            //mostrarPromedioAvionesJet(lista,TAM,listaAerolinea,TAM_AER);
            mostrarInformes(lista,TAM,listaAerolinea,TAM_AER,listaTipo,TAM_TIPO,listaDestino,TAM_DEST,listaVuelo,TAM_V);
            break;
        case 'K':
            printf("Salir\n");
            seguir = 'n';
